...
The code consists of 9 Fortran source files: dynamic.f90, emission.f90, functions.f90, initial condition.f90, mainprogram.f90, method.f90, model.f90, operations.f90, and parameters.f90.
